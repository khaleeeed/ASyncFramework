...
var Dashboard = function() {
    ...
    var dailySales = function() {
        ...
        var chartData = {
            labels: ["الإصدار الأول", "الإصدار الثاني", "الإصدار الثالث", "الإصدار الرابع", "الإصدار الخامس", "الإصدار السادس", "الإصدار السابع", "الإصدار الثامن", "الإصدار التاسع", "الإصدار العاشر", "الإصدار الحادي عشر", "الإصدار  الثاني عشر", "الإصدار الثالث عشر", "الإصدار الرابع عشر"],
            datasets: [{
                //label: 'Dataset 1',
...
//                    }
	    ...
	    var personalIncome2 = function() {
        //** Based on Chartist plugin - https://gionkunz.github.io/chartist-js/index.html
        var quater1Chart = function() {
            if ($('#m_chart_personal_income_quater_1_2').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_1_2', {
                series: [{
                        value: 5,
                        className: 'custom',
                        meta: {
...
//                       }
        ...
        var quater2Chart = function() {
            if ($('#m_chart_personal_income_quater_2_2').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_2_2', {
                series: [{
                        value: 65,
                        className: 'custom',
                        meta: {
...
//                    }
        ...
        var quater3Chart = function() {
            if ($('#m_chart_personal_income_quater_3_2').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_3_2', {
                series: [{
                        value: 5,
                        className: 'custom',
                        meta: {
...
//                    }
       ...
       var quater4Chart = function() {
            if ($('#m_chart_personal_income_quater_4_2').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_4_2', {
                series: [{
                        value: 50,
                        className: 'custom',
                        meta: {
...
//                    }
	    ...
	    $( document ).find( 'a[data-toggle="pill"]' ).on( 'shown.bs.tab', function( e ) {
		    var target = $( e.target ).attr( 'href' );
		    switch ( target ) {
			    case '#m_personal_income_quater_1_2':
				    quater1Chart();
				    break;
			    case '#m_personal_income_quater_2_2':
				    quater2Chart();
				    break;
                case '#m_personal_income_quater_3_2':
                    quater3Chart();
                    break;  
                case '#m_personal_income_quater_4_2':
                    quater4Chart();
                    break;       
		    }
	    } );
	    ...
	    var personalIncome3 = function() {
        //** Based on Chartist plugin - https://gionkunz.github.io/chartist-js/index.html
        var quater1Chart = function() {
            if ($('#m_chart_personal_income_quater_1_3').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_1_3', {
                series: [{
                        value: 5,
                        className: 'custom',
                        meta: {
...
//                       }
        ...
        var quater2Chart = function() {
            if ($('#m_chart_personal_income_quater_2_3').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_2_3', {
                series: [{
                        value: 65,
                        className: 'custom',
                        meta: {
...
//                    }
        ...
        var quater3Chart = function() {
            if ($('#m_chart_personal_income_quater_3_3').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_3_3', {
                series: [{
                        value: 5,
                        className: 'custom',
                        meta: {
...
//                    }
       ...
       var quater4Chart = function() {
            if ($('#m_chart_personal_income_quater_4_3').length == 0) {
                return;
            }

            var chart = new Chartist.Pie('#m_chart_personal_income_quater_4_3', {
                series: [{
                        value: 50,
                        className: 'custom',
                        meta: {
...
//                    }
	    ...
	    $( document ).find( 'a[data-toggle="pill"]' ).on( 'shown.bs.tab', function( e ) {
		    var target = $( e.target ).attr( 'href' );
		    switch ( target ) {
			    case '#m_personal_income_quater_1_3':
				    quater1Chart();
				    break;
			    case '#m_personal_income_quater_2_3':
				    quater2Chart();
				    break;
                case '#m_personal_income_quater_3_3':
                    quater3Chart();
                    break;  
                case '#m_personal_income_quater_4_3':
                    quater4Chart();
                    break;       
		    }
	    } );
