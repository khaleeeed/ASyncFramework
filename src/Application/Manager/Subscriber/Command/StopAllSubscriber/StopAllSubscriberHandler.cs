...
namespace ASyncFramework.Application.Manager.Subscriber.Command.StopAllSubscriber
{
    public class StopAllSubscriberHandler : IRequestHandler<StopAllSubscriberCommand, Result>
    {
        public Task<Result> Handle(StopAllSubscriberCommand request, CancellationToken cancellationToken)
        {
            ...
            for (int i = 0; i < request.Urls.Count; i++)
            {
                ...
                try
                {
                    ...
                    string Url = $"{request.Urls[index]}api/Subscriber/Stop";
    ...
    public class StopAllSubscriberCommand:IRequest<Result>
    {
